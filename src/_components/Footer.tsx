...
const Footer = (props: Props) => {
    return (
        <div className='flex flex-col items-center'>
                ...
                <div className='bg-primary-pink relative top-12 taptop:top-16 w-[80vw] max-w-[1280px] min-w-[17rem] h-16 taptop:h-20 laptop:h-24 rounded-full shadow-lg flex items-center justify-center px-10 tablet:px-5 laptop:px-8'>
                    ...
                    <div className='flex gap-3'>
                        <Link
                            ...
                            className={`${nunito.className} w-28 h-8 desktop:w-36 desktop:h-10 desktop:text-xl transition-all bg-background hover:bg-background-secondary text-primary-pink rounded-full flex items-center gap-2 justify-center tracking-wide shadow-[4.0px_4.0px_5.0px_rgba(0,0,0,0.25)]`}
                        >
                            Volunteer
                        </Link>
                        <Link
                            href='/signup?isVolunteer=false'
                            className={`${nunito.className} w-28 h-8 desktop:w-36 desktop:h-10 desktop:text-xl border border-background transition-all bg-primary-pink hover:bg-primary-pink-light text-background rounded-full flex items-center gap-2 justify-center tracking-wide shadow-[4.0px_4.0px_5.0px_rgba(0,0,0,0.1)]`}
                        >
                            Sign Up
                        </Link>
                    </div>
            ...
            <div className='bg-primary h-full w-full flex flex-col items-center pt-10 px-5 pb-3'>
                <ContactUs />
