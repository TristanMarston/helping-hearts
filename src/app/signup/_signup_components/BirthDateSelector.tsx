        ...
        <div className='flex flex-col gap-y-4 tablet:gap-y-0 tablet:grid tablet:grid-rows-2 tablet:grid-cols-[2fr_3fr_2fr] tablet:gap-x-2'>
                ...
                <SelectContent className='bg-background rounded-[13px] border border-gray-100 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'>
                    <SelectGroup>
                        {yearsArray.map((year, index) => (
                            <SelectItem key={year + index} value={year} className='hover:bg-background-dark font-fredoka text-base cursor-pointer'>
                                {year}
                            </SelectItem>
                        ))}
                    </SelectGroup>
                ...
                <SelectContent className='bg-background rounded-[13px] border border-gray-100 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'>
                    <SelectGroup>
                        {monthsArray.map((month, index) => (
                            <SelectItem key={month + index} value={month} className='hover:bg-background-dark font-fredoka text-base cursor-pointer'>
                                {month}
                            </SelectItem>
                        ))}
                    </SelectGroup>
            ...
            <Popover>
                <PopoverTrigger asChild>
                    <button
                        className={cn(
                            `font-fredoka font-normal px-4 py-3 cursor-pointer w-full min-w-[87px] truncate h-11 text-base flex justify-start items-center bg-background hover:bg-background-secondary transition-all text-gray-500 appearance-none rounded-[10px] border border-gray-100 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]`,
                ...
                <PopoverContent className='w-auto p-0 rounded-[14px] border border-gray-100 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'>
                    <Calendar
                        mode='single'
                        ...
                        className='bg-background rounded-[14px]'
                    />
                </PopoverContent>
            </Popover>
        </div>
